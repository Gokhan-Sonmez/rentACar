...
public class Messages {
	...
	public static final String colorNotDeleted = "color.not.deleted";
	public static final String colorIdNotExists = "color.id.not.exists";
	public static final String colorListed = "color.listed";
	...
	public static final String corparateCustomerUpdated = "corparate.customer.updated";
	public static final String corparateCustomerDeletes = "corparate.customer.deleted";
	...
	public static final String cityUpdated = "city.added";
	...
	public static final String paymentListed =  "payment.listed";
